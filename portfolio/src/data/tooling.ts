...
export const toolingGroups: ToolingGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Vue', icon: { name: 'vuejs', variant: 'plain' } },
      ...
      { label: 'shadcn/ui' },
      { label: 'Design tokens' },
      { label: 'Figma', icon: { name: 'figma', variant: 'plain' } },
      { label: 'TanStack Query' },
      { label: 'Zustand', icon: { name: 'zustand', variant: 'plain' } },
      { label: 'Jotai' },
      { label: 'Redux', icon: { name: 'redux', variant: 'original' } },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'PHP', icon: { name: 'php', variant: 'plain' } },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'CI/CD' },
      { label: 'Render' },
      { label: 'Cloudflare', icon: { name: 'cloudflare', variant: 'plain' } },
