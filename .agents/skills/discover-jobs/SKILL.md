...
2. Search target titles and semantic variants. Prioritize international employers that can hire remotely from the Philippines. In `AUTONOMOUS_CAMPAIGN`, exhaust `P0_FRESH` (0-7 days) before `P1_RECENT` (8-14 days); normally exclude older listings.
